...
Публичное портфолио-демо AI-диспетчера и read-only CRM для вымышленной
выездной сервисной компании.
...
Публичная read-only CRM доступна без регистрации и логина:
