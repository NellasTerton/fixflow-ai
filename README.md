...
1. Откройте `/chat` и опишите проблему своими словами, например
   «не работает стиральная машина, не сливает воду».
2. Ответьте на пару вопросов чата: имя, демонстрационный телефон вида
   `+380 00 000 1042`, район, дату и время.
3. Заявка сразу появится в `/workspace/leads`; карточка заявки показывает
   раздел «Почему AI так ответил?» с источниками RAG и журнал автоматизаций
   Make/Telegram.
