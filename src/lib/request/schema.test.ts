...
const validRequest = {
  ...
  phone: "+380 (00) 000-1042",
  category: "plumbing",
  serviceId: "10000000-0000-4000-8000-000000000005",
  problemDescription: "Демонстрационная протечка в тестовой зоне.",
  area: "Демо-район Северный",
...
describe("public request validation", () => {
  it("normalizes and accepts only a safe demo phone", () => {
    expect(normalizePhone("+380 (00) 000-1042")).toBe("+380000001042");

    const result = createPublicRequestSchema(now).parse(validRequest);

    expect(result.phone).toBe("+380000001042");
  });
